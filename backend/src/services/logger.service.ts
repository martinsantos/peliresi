...
export type AccionLog =
  ...
  // Admin Sectorial
  | 'VER_DASHBOARD_TRANSPORTISTAS' | 'APROBAR_TRANSPORTISTA'
  | 'VER_DETALLE_TRANSPORTISTA' | 'ACTUALIZAR_TRANSPORTISTA'
  | 'VER_DASHBOARD_OPERADORES' | 'APROBAR_OPERADOR'
  | 'VER_DETALLE_OPERADOR' | 'ACTUALIZAR_OPERADOR'
  | 'VER_DASHBOARD_GENERADORES' | 'APROBAR_GENERADOR'
  | 'VER_DETALLE_GENERADOR' | 'ACTUALIZAR_GENERADOR' | 'ELIMINAR_GENERADOR'
  // Reversiones
  | 'REVERSION_ESTADO';

export type ModuloLog = 'AUTH' | 'MANIFIESTOS' | 'USUARIOS' | 'REPORTES' | 'SISTEMA' | 'PUSH' | 'ADMIN_SECTORIAL' | 'REVERSIONES';
