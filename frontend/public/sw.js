...
// Scope: / (main site)
const CACHE_NAME = 'trazabilidad-rrpp-v28';
const RUNTIME_CACHE = 'runtime-cache-v28';
...
self.addEventListener('activate', (event) => {
    console.log('[SW] Activando Service Worker v28...');
    event.waitUntil(
...
console.log('[SW] Service Worker v28 cargado');
