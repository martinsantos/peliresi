...
// Scope: / (main site)
const CACHE_NAME = 'trazabilidad-rrpp-v27';
const RUNTIME_CACHE = 'runtime-cache-v27';
...
self.addEventListener('install', (event) => {
    console.log('[SW] Installing Service Worker v27...');
    event.waitUntil(
...
self.addEventListener('activate', (event) => {
    console.log('[SW] Activando Service Worker v27...');
    event.waitUntil(
...
console.log('[SW] Service Worker v27 cargado');
