...
// Scope: / (main site)
const CACHE_NAME = 'trazabilidad-rrpp-v29';
const RUNTIME_CACHE = 'runtime-cache-v29';
...
self.addEventListener('activate', (event) => {
    console.log('[SW] Activando Service Worker v29...');
    event.waitUntil(
...
console.log('[SW] Service Worker v29 cargado');
